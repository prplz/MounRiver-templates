...
#define REG_I2C_CNT_TSUTHD_OPEN      (0x0010)
#define REG_MASK_I2C_CNT_TSUTDH_OPEN (BIT5 | BIT4)

#define REG_I2C_CNT_TSU_SET  (0x11)
#define REG_MASK_CNT_TSU_SET (0xFFFF)
#define REG_I2C_CNT_THD_SET  (0x12)
#define REG_MASK_CNT_TDH_SET (0xFFFF)
...
#define REG_MASK_DMA_RESET   (0x0001)
#define REG_MASK_LASTDONE    (0x00FF)

#define REG_I2C_WN_GROUP_LEN  (0x0032)
#define REG_MASK_WN_GROUP_LEN (0x000F)

#define REG_I2C_WN_MODE     (0x0033)
#define REG_MASK_WN_MODE_EN (BIT0)
#define REG_MASK_WN_RS_P    (BIT1)

#define REG_I2C_WN_WAIT_CNT  (0x0034)
#define REG_MASK_WN_WAIT_CNT (0xFFFF)
/**************************************************/
