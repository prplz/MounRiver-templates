...
#define CFGR0_PLL_Mask              ((uint32_t)0xFFC0FFFF)  /* 107 */
#define CFGR0_PLL_Mask_1            ((uint32_t)0xFFC2FFFF)  /* 103 */
 ...
 *
 * @param   RCC_PCLK2 - defines the USB clock divider. This clock is derived from
