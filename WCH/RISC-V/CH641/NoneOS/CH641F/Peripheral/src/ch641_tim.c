 ...
 *            TIM_IT_CC3 - TIM Capture Compare 3 Interrupt source(TIM2 not support).
 ...
 *            TIM_TS_ITR2 - Internal Trigger 2(TIM2 not support).
 *            TIM_TS_ITR3 - Internal Trigger 3(TIM2 not support).
 *
 * @return  none
 */
 ...
 *            TIM_TS_ETRF - External Trigger input(TIM2 not support).
 *
 * @return  none
 */
 ...
 *
 * @brief   Set dead time for TIM2.
 *
 * @param   TIMx - where x can be 2 select the TIM peripheral.
 *          TIM_Channel - specifies the TIM Channel.
 *            TIM_Channel_1 - TIM Channel 1.
 *            TIM_Channel_2 - TIM Channel 2.
 *          DeadTime - This parameter can be a number between 0x00 and 0x0F
 *
 * @return  none
 */
