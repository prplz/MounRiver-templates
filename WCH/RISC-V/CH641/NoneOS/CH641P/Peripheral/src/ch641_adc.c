 ...
 *            ADC_Channel_VHV - ADC Channel15 selected.
 ...
 *        injected conversion.
 *            ADC_ExternalTrigInjecConv_T1_CC1 - Timer1 capture compare1 selected.
 *            ADC_ExternalTrigInjecConv_T1_CC2 - Timer1 capture compare2 selected.
 ...
 *            ADC_ExternalTrigInjecConv_Ext_PA4_PA15 - PA4 or PA15 selected.
...
/*********************************************************************
 * @fn      ADC_InjectedConvCmd
 *
 * @brief   Enables or disables injected channels conversion.
 *
 * @param   ADCx - where x can be 1 to select the ADC peripheral.
 *          NewState - ENABLE or DISABLE.
 *
...
/*********************************************************************
 * @fn      ADC_RegularConvCmd
 *
 * @brief   Enables or disables regular channels conversion.
 *
 * @param   ADCx - where x can be 1 to select the ADC peripheral.
 *          NewState - ENABLE or DISABLE.
 *
 * @return  none
 */
void ADC_RegularConvCmd(ADC_TypeDef *ADCx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ADCx->CTLR2 &= ~(1<<29);
...
/*********************************************************************
 * @fn      ADC_ExternalTrigInjected_T1_CC1_Cmd
 *
 * @brief   Enables or disables T1_CC1 as injected channels conversion external trigger event.
 *
 * @param   ADCx - where x can be 1 to select the ADC peripheral.
 *          NewState -
 *            ENABLE - T1_CC1 as injected channels conversion external trigger event.
 *            DISABLE - T1_CC1 as regular channels conversion external trigger event.
 *
 * @return  none
 */
void ADC_ExternalTrigInjected_T1_CC1_Cmd(ADC_TypeDef *ADCx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ADCx->CTLR2 |= (1<<24);
...
/*********************************************************************
 * @fn      ADC_ExternalTrigInjected_T1_CC2_Cmd
 *
 * @brief   Enables or disables T1_CC2 as injected channels conversion external trigger event.
 *
 * @param   ADCx - where x can be 1 to select the ADC peripheral.
 *          NewState -
 *            ENABLE - T1_CC2 as injected channels conversion external trigger event.
 *            DISABLE - T1_CC2 as regular channels conversion external trigger event.
 *
 * @return  none
 */
void ADC_ExternalTrigInjected_T1_CC2_Cmd(ADC_TypeDef *ADCx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ADCx->CTLR2 |= (1<<25);
...
/*********************************************************************
 * @fn      ADC_ExternalTrigInjected_T1_CC3_Cmd
 *
 * @brief   Enables or disables T1_CC3 as injected channels conversion external trigger event.
 *
 * @param   ADCx - where x can be 1 to select the ADC peripheral.
 *          NewState -
 *            ENABLE - T1_CC3 as injected channels conversion external trigger event.
 *            DISABLE - T1_CC3 as regular channels conversion external trigger event.
 *
 * @return  none
 */
void ADC_ExternalTrigInjected_T1_CC3_Cmd(ADC_TypeDef *ADCx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ADCx->CTLR2 |= (1<<26);
...
/*********************************************************************
 * @fn      ADC_ExternalTrigInjected_T2_CC1_Cmd
 *
 * @brief   Enables or disables T2_CC1 as injected channels conversion external trigger event.
 *
 * @param   ADCx - where x can be 1 to select the ADC peripheral.
 *          NewState -
 *            ENABLE - T2_CC1 as injected channels conversion external trigger event.
 *            DISABLE - T2_CC1 as regular channels conversion external trigger event.
 *
 * @return  none
 */
void ADC_ExternalTrigInjected_T2_CC1_Cmd(ADC_TypeDef *ADCx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ADCx->CTLR2 |= (1<<27);
...
/*********************************************************************
 * @fn      ADC_ExternalTrigInjected_T2_CC2_Cmd
 *
 * @brief   Enables or disables T2_CC2 as injected channels conversion external trigger event.
 *
 * @param   ADCx - where x can be 1 to select the ADC peripheral.
 *          NewState -
 *            ENABLE - T2_CC2 as injected channels conversion external trigger event.
 *            DISABLE - T2_CC2 as regular channels conversion external trigger event.
 *
 * @return  none
 */
void ADC_ExternalTrigInjected_T2_CC2_Cmd(ADC_TypeDef *ADCx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ADCx->CTLR2 |= (1<<28);
