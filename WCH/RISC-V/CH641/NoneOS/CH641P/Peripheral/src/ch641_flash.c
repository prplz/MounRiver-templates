 ...
 *            OB_RST_NoEN - Reset IO disable (PA6)
 *            OB_RST_EN_DT12ms - Reset IO enable (PA6) and  Ignore delay time 12ms
 *            OB_RST_EN_DT1ms - Reset IO enable (PA6) and  Ignore delay time 1ms
 *            OB_RST_EN_DT128us - Reset IO enable (PA6) and  Ignore delay time 128us
 ...
 *
 * @return  The FLASH User Option Bytes values: RST_STOP(Bit1)
 *        and RST_STDBY(Bit2).
 */
