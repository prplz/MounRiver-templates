...
#define __CH641_STDPERIPH_VERSION_SUB    (0x00) /* [7:0] sub version */
...
#define FLASH_CTLR_FTPG                         ((uint32_t)0x00010000) /* Fast Page Programming 64Byte */
#define FLASH_CTLR_FTER                         ((uint32_t)0x00020000) /* Fast Page Erase 64Byte */
...
#define RCC_USBPDEN                             ((uint16_t)0x0080)
...
#define TIM_CCR1                                ((uint16_t)0x0000FFFF) /* Capture/Compare 1 Value */
#define TIM_LEVEL1                              ((uint16_t)0x00010000)

/*******************  Bit definition for TIM_CH2CVR register  *******************/
#define TIM_CCR2                                ((uint16_t)0x0000FFFF) /* Capture/Compare 2 Value */
#define TIM_LEVEL2                              ((uint16_t)0x00010000)

/*******************  Bit definition for TIM_CH3CVR register  *******************/
#define TIM_CCR3                                ((uint16_t)0x0000FFFF) /* Capture/Compare 3 Value */
