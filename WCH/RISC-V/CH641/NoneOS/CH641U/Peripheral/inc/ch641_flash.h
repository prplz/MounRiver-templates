...
*******************************************************************************/
#ifndef __CH641_FLASH_H
#define __CH641_FLASH_H
...
/* Values to be used with CH641 devices (1page = 64Byte) */
...
#define OB_RST_NoEN                      ((uint16_t)0x0018) /* Reset IO disable (PA6)*/
#define OB_RST_EN_DT12ms                 ((uint16_t)0x0010) /* Reset IO enable (PA6) and  Ignore delay time 12ms */
#define OB_RST_EN_DT1ms                  ((uint16_t)0x0008) /* Reset IO enable (PA6) and  Ignore delay time 1ms */
#define OB_RST_EN_DT128us                ((uint16_t)0x0000) /* Reset IO enable (PA6) and  Ignore delay time 128us */
...
/*Functions used for all CH641 devices*/
